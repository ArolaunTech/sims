...
def sim_craft(craft, log=False):
    simulate_landing_with_craft(craft, "vall", 6000, logging=log)
    craft.use_dv(1100)
    simulate_landing_with_craft(craft, "tylo", 9100, logging=log)
...
sim_craft(craft, output_ascent_profiles)
